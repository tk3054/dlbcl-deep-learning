...
def combine_measurements(sample_folder, image_number, base_path, channel_config=None,
    ...
    include_channels = _ordered_unique(include_channels)
    null_channels = _ordered_unique(null_channels)
    ...
    if include_channels:
        ...
        default_order = _ordered_unique(channel_config.keys()) or []
        default_keys = [ch for ch in default_order if ch in channel_patterns]
...
def main():
    ...
    parser.add_argument("--base-path", default=BASE_PATH, required=BASE_PATH is None,
