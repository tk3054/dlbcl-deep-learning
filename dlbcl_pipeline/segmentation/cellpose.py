...
def _load_cellpose():
    try:
        ...
        raise ImportError("Cellpose not installed. Install with: pip install cellpose") from exc
...
def segment_cells_with_cellpose(image, mask=None, model_type='cyto2', diameter=None,
    ...
    """
    models, transforms = _load_cellpose()
