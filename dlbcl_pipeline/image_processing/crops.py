...
import numpy as np
import tifffile
from dlbcl_pipeline.image_processing.masks import get_mask_crop_bounds, make_soft_mask


def make_raw_crops(sample_folder, image_number, base_path, source_image,
    ...
    Args:
        ...
        output_dir_name: Output directory name (default: "raw_actin")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir-name", default="raw_actin", help="Output directory name")
